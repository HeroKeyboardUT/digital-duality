...
export const heroStats: Stat[] = [
  ...
  { label: 'School Year', labelVn: 'Năm Học', value: 'Y2' },
...
export const cvStats: Stat[] = [
  { label: 'Projects Completed', labelVn: 'Dự Án Hoàn Thành', value: '7+', icon: 'FolderOpen' },
  { label: 'Technologies Used', labelVn: 'Công Nghệ Sử Dụng', value: '15+', icon: 'Code' },
  { label: 'GitHub Commits', labelVn: 'GitHub Commits', value: '100+', icon: 'GitCommit' },
